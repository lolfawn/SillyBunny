...
- Added an update-safety migration that disables old bundled Moonlit Echoes state and shows a Launchpad notice for installing or enabling the SillyBunny fork.
